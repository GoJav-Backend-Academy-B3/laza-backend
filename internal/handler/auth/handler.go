...
func (h *authHandler) GetHandlers() (hs []handlers.HandlerStruct) {
	hs = append(hs,
		...
		handlers.HandlerStruct{Method: http.MethodGet, Path: "/auth/google", HandlerFunc: h.loginGoogle},
		handlers.HandlerStruct{Method: http.MethodGet, Path: "/auth/google/callback", HandlerFunc: h.loginGoogleCallback},
		...
		handlers.HandlerStruct{Method: http.MethodPost, Path: "/auth/verification-code", HandlerFunc: h.verificationCode},
